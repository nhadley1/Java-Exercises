// OrderedLinkedStrings_LiveCoding_3.java
// Jim Jerkofsky  10/26/18
// Class to manage an ordered linked list of LinkedString objects.
// Live Coding #3: 
//   Add:
//      Option to remove first object in list.
//      Option to remove last object in list.
import java.util.Scanner;


public class OrderedLinkedStrings_LiveCoding_3
{
  public static void main(String[] args)
  {
    ...
    while(response != 0)
    {
      ...
      System.out.println("3]  Remove first string in list.");
      System.out.println("4]  Remove last string in list.");
